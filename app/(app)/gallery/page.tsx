              ...
              {filteredMedia.map((item, index) => (
                ...
                >
                  ...
                  <div className='p-4 space-y-2'>
                    ...
                    {!item.description && <div className='h-9'></div>}
